...
import { create, createImage, deleteModel, get, getCars, getImages, update } from "../controllers/models.js";
...
router.post("/models/delete/:id", authenticateToken, deleteModel)
